import{z as re,B as ae,D as se,i as f,r as E,d as g,x as n,F as D,e as Q,y as Z,R as l,v,j as H,n as ce,G as C,k as le,g as q,H as M,M as h,O as A,C as V,I as F,p as $,A as B,o as de,J as we,f as ue,m as pe}from"./index-y0uy2AHK.js";import{c as u,n as w,r as d,o as X,U as me}from"./index-DZgel6US.js";const m=re({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),T={state:m,subscribe(a){return se(m,()=>a(m))},subscribeKey(a,e){return ae(m,a,e)},showTooltip({message:a,triggerRect:e,variant:t}){m.open=!0,m.message=a,m.triggerRect=e,m.variant=t},hide(){m.open=!1,m.message="",m.triggerRect={width:0,height:0,top:0,left:0}}},he=f`
  :host {
    display: block;
